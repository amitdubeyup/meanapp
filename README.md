...
## 📝 About The Project
Custom software solution built with Angular, Express developed to address specific business requirements for Mean Stack Crud.
...
## 🛠️ Tech Stack
*   **Node.js, MongoDB, Angular, TypeScript, Express**

## 📦 Installation

1.  **Clone the repository**:
    ```bash
    git clone git@github.com:amitdubeyup/mean-stack-crud.git
    ```
